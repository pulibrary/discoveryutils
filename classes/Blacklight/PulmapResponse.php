...
class PulmapResponse
{
  ...
  public static function getRecords(array $record_list, string $host) {
    ...
    foreach($record_list as $record) {
      ...
      if (isset($record["attributes"]["dc_publisher_s"])) {
        $parsed_record["publisher"] = $record["attributes"]["dc_publisher_s"]["attributes"]["value"];
      }
      if (isset($record["attributes"]["dc_format_s"])) {
         $parsed_record["type"] = $record["attributes"]["dc_format_s"]["attributes"]["value"];
      }
      if (isset($record["attributes"]["dc_description_s"])) {
        $parsed_record["description"] = $record["attributes"]["dc_description_s"]["attributes"]["value"];
      }
